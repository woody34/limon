...
import {
  ...
  ArrowPathIcon,
  ArrowUpCircleIcon,
} from "npm:@heroicons/react@2.0.18/20/solid";
          ...
          <div class="flex flex-1 items-center justify-end gap-x-8">
            ...
            <a href="#" class="-m-1.5 p-1.5">
              ...
              <img
                ...
                src="https://media.licdn.com/dms/image/C4E03AQH_B6XImFLa0Q/profile-displayphoto-shrink_100_100/0/1523220489112?e=1700092800&v=beta&t=JWuBwerSVp3_LYpQAq3DavBw_mEtNyOh8JqK9BsI6F0"
                alt=""
              />
            </a>
          </div>
          ...
          <header class="pb-4 pt-6 sm:pb-6">
            <div class="mx-auto flex max-w-7xl flex-wrap items-center gap-6 px-4 sm:flex-nowrap sm:px-6 lg:px-8">
              ...
              <div class="order-last flex w-full gap-x-8 text-sm font-semibold leading-6 sm:order-none sm:w-auto sm:border-l sm:border-gray-200 sm:pl-6 sm:leading-7">
                <a href="#" class="text-green-600">Last 7 days</a>
                <a href="#" class="text-gray-700">Last 30 days</a>
                <a href="#" class="text-gray-700">All-time</a>
              </div>
              <a
                href="#"
                class="ml-auto flex items-center gap-x-1 rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600"
              >
                <svg
                      ...
                      <tr>
                        ...
                        <td class="py-5 text-right">
                          <div class="flex justify-end">
                            <a
                              href="#"
                              class="text-sm font-medium leading-6 text-green-600 hover:text-green-500"
                            >
